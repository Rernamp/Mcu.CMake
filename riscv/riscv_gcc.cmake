...
FIND_FILE( RISCV_XPACK_GCC_COMPILER_EXE "riscv32-wch-elf-gcc.exe" PATHS ENV INCLUDE)
FIND_FILE( RISCV_XPACK_GCC_COMPILER "riscv32-wch-elf-gcc" PATHS ENV INCLUDE)

# Select which is found
if (EXISTS ${RISCV_XPACK_NEW_GCC_COMPILER})
set( RISCV_GCC_COMPILER ${RISCV_XPACK_NEW_GCC_COMPILER})
elseif (EXISTS ${RISCV_XPACK_NEW_GCC_COMPILER_EXE})
...
message(FATAL_ERROR "RISC-V GCC not found. ${RISCV_GITHUB_GCC_COMPILER} ${RISCV_XPACK_GCC_COMPILER} ${RISCV_GITHUB_GCC_COMPILER_EXE} ${RISCV_XPACK_GCC_COMPILER_EXE} ${RISCV_XPACK_NEW_GCC_COMPILER_EXE}")
endif()
...
set(CMAKE_LIBRARY_ARCHITECTURE riscv32-wch-elf)
